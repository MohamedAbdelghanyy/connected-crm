...
import { DataTableDynamicPagination } from "./data-table-dynamic-pagination"
...
export function DynamicDataTable<TData, TValue>({ columns, data, toolbar, toolbarSearchList, pagination }: DynamicDataTableProps<TData, TValue>) {
  ...
  return (
    <div className="space-y-4">
      ...
      {(toolbar.length != 0 || toolbarSearchList.length != 0) && <DataTableDynamicPagination table={table} pagination={pagination} />}
    </div>
  )
}
