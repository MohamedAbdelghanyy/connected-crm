...
export default function UserTabs({ user, products, wishlist, calls, subscriptions, notifications, appointments, internalNotes, stats, history }: any) {
  ...
  return user ? (
    <>
      <DashboardShell className="mb-1">
        <DashboardHeader heading={user.name} text={user.id}></DashboardHeader>
      </DashboardShell>
            ...
            <TabsContent value="info" forceMount={true} hidden={activeTab !== "info"}>
              <div className="space-y-4 py-2 pb-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="birthdate" value={user.birthdate} readOnly />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="customerType" value={user.customerType} readOnly />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="occupation">Occupation</Label>
                  <Input id="occupation" value={user.occupation} readOnly />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="interests" value={user.interests} readOnly />
                </div>
              </div>
            </TabsContent>
            <TabsContent value="products" forceMount={true} hidden={activeTab !== "products"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Products'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
            <TabsContent value="wishlist" forceMount={true} hidden={activeTab !== "wishlist"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Wishlist'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
            <TabsContent value="calls" forceMount={true} hidden={activeTab !== "calls"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Calls'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
            <TabsContent value="notifications" forceMount={true} hidden={activeTab !== "notifications"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Notifications'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
            <TabsContent value="subscriptions" forceMount={true} hidden={activeTab !== "subscriptions"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Subscriptions'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
            <TabsContent value="appointments" forceMount={true} hidden={activeTab !== "appointments"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Appointments'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
            <TabsContent value="internalNotes" forceMount={true} hidden={activeTab !== "internalNotes"}>
              <div className="space-y-4 py-2 pb-4">
                <div className="space-y-2">
                  ...
                  ) : (<CustomEmptyPlaceHolder title={'Internal Notes'} customerName={user.name} />)}
                </div>
              </div>
            </TabsContent>
          </div>
