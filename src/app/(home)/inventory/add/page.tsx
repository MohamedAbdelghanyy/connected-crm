...
import { InventoryProductObject } from "@/config/forms/defaultObjects"
...
export default function AddItemPage() {
  ...
  const methods = useForm({
    mode: 'onChange',
    defaultValues: InventoryProductObject.empty,
    resolver: yupResolver(InventoryProductValidation.mainSchema),
  });
